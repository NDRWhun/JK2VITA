...
static char	SaberParms[MAX_SABER_DATA_SIZE];	// static so it doesn't clash with wp_saberLoad's copy in the single-ELF build
...
static saber_colors_t TranslateSaberColor( const char *name )	// static; the game's NPC_stats.cpp owns the linked one
{
